...
if(isset( $_POST['cpbtn'] )){
	...
	if($row['password']==$opwd){
		if($npwd==$rnpwd){
			$q="UPDATE users SET password='$npwd' WHERE uid='$uid'";
		...
		<div class="row">
			...
			<div class="col-md-4 sidebar">
				...
				<div class="list-group">
				  ...
				  <a href="#" class="list-group-item">Langauge</a>
			...
			<div class="col-md-8">
				<form id="regForm" method="post">
					  <div class="form-group">
						<input type="password" class="form-control required" id="opwd" name="opwd" placeholder="Old Password">
					  </div>
					  <div class="form-group">
						<input type="password" class="form-control required" id="npwd" name="npwd" placeholder="New Password">
					  </div>
					  <div class="form-group">
						<input type="password" class="form-control required" id="rnpwd" name="rnpwd" placeholder="Retype New Password">
					  </div>
					  <input type="submit" class="btn btn-success" name="cpbtn" value="Change Password"  style="width:30%; -webkit-box-shadow: -1px 9px 33px 0px rgba(0,0,0,0.75);
